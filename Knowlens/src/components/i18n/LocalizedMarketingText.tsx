...
const marketingTextTranslations: Record<string, string> = {
  ...
  "Create Science Infographics for Clear Learning": "创建更易理解的科学信息图",
  "Create a Science Infographic in 3 Steps": "三步创建科学信息图",
  "Science Topics You Can Turn into Infographics": "适合转成信息图的科学主题",
  "Built for Science Learning and Communication": "为科学学习与传播而设计",
  "Designed for Readable Science Infographics": "为清晰易读的科学信息图而设计",
  "Create Earth Science Infographics for Clear Learning": "创建更易理解的地球科学信息图",
  "Create an Earth Science Infographic in 3 Steps": "三步创建地球科学信息图",
  "Earth Science Topics You Can Turn into Infographics": "适合转成信息图的地球科学主题",
  "Built for Earth Science Learning and Communication": "为地球科学学习与传播而设计",
  "Designed for Readable Earth Science Infographics": "为清晰易读的地球科学信息图而设计",
  "Earth Science Infographic Generator FAQ": "地球科学信息图生成器常见问题",
  "Create Process Infographics for Clear Step-by-Step Explanation": "创建步骤清晰的流程信息图",
  "Create a Process Infographic in 3 Steps": "三步创建流程信息图",
  "Built for Workflows, Tutorials, and Step-by-Step Guides": "适合工作流、教程和分步指南",
  "Designed for Readable Process Infographics": "为清晰易读的流程信息图而设计",
  "Process Infographic Generator FAQ": "流程信息图生成器常见问题",
  "Create Recipe Infographics for Clear Step-by-Step Cooking": "创建步骤清楚的食谱信息图",
  "Create a Recipe Infographic in 3 Steps": "三步创建食谱信息图",
  "Built for Recipes, Food Content, and Cooking Guides": "适合食谱、食品内容和烹饪指南",
  "Designed for Readable Recipe Infographics": "为清晰易读的食谱信息图而设计",
  "Recipe Infographic Maker FAQ": "食谱信息图制作器常见问题",
  "Create Educational Infographics for Clear Learning": "创建更易理解的教育信息图",
  "Create an Educational Infographic in 3 Steps": "三步创建教育信息图",
  "Educational Topics You Can Turn into Infographics": "适合转成信息图的教学主题",
  "Built for Teaching, Studying, and Explaining": "适合教学、复习和讲解",
  "Designed for Readable Educational Infographics": "为清晰易读的教育信息图而设计",
  "Educational Infographic Maker FAQ": "教育信息图制作器常见问题",
  "Featured Infographic Examples": "精选信息图案例",
  "What Are Infographic Examples?": "什么是信息图案例？",
  "Why Browse Infographic Examples?": "为什么要浏览信息图案例？",
  "Text-to-Infographic Examples": "文本转信息图案例",
  "Create Infographics from Plain Text": "用纯文本创建信息图",
  "Built for Learning, Explaining, and Sharing": "适合学习、讲解和分享",
  "Create Posters for Any Idea": "为任何想法生成海报",
  "Built for Learning, Social Media, and Quick Visual Communication": "适合学习、社交媒体和快速视觉表达",
  "Create a Carousel in 3 Steps": "三步创建轮播图",
  "Create a Short Video in 3 Steps": "三步创建短视频",
  "Built for Educators, Students, and Knowledge Creators": "适合老师、学生和知识创作者",
  "Built for Educators, Students, and Science Communicators": "适合老师、学生和科学传播者",
  "Built for Learning, Sharing, and Explaining": "适合学习、分享和讲解",
  "Built for Review and Teaching": "适合复习和教学",
  "Built for Anyone Who Needs Clear Visual Content": "适合任何需要清晰视觉内容的人",

  "AI Infographic Generator": "AI 信息图生成器",
  "Text to Infographic": "文本转信息图",
  "Infographic Maker": "信息图制作器",
  "Science Infographic Generator": "科学信息图生成器",
  "Biology Infographic Generator": "生物信息图生成器",
  "Earth Science Infographic Generator": "地球科学信息图生成器",
  "Process Infographic Generator": "流程信息图生成器",
  "Recipe Infographic Maker": "食谱信息图制作器",
  "AI Explainer Videos": "AI 解说视频",
  "AI Video Generator": "AI 视频生成器",
  "Text to Video": "文本转视频",
  "AI Poster Generator": "AI 海报生成器",
  "AI Carousel Generator": "AI 轮播图生成器",
  "Tools": "工具",
  "Pricing": "价格",
  "Create": "创建",
  "Generate": "生成",
