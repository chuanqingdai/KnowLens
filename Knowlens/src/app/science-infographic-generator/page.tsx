    ...
    <MarketingChrome>
      ...
      <section className="mx-auto grid w-full max-w-6xl gap-8 px-4 pb-12 pt-10 sm:px-6 lg:grid-cols-[minmax(0,0.95fr)_minmax(420px,1fr)] lg:items-center lg:pt-16">
        <div className="text-center lg:text-left">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-6 text-zinc-500 lg:mx-0">
            For best results, paste a complete science explanation with key points, steps, facts, or examples.
          </p>
          <p className="mt-2 text-sm text-zinc-500">Built for classroom visuals, study guides, science communication, and visual learning.</p>
        </div>
        ...
        <div className="mx-auto w-full max-w-[640px] lg:mx-0">
          <article className="overflow-hidden rounded-2xl border border-zinc-200 bg-white p-2 shadow-sm">
            <img
              ...
              className="aspect-[16/9] w-full rounded-xl bg-zinc-50 object-contain"
              loading="eager"
            />
            <div className="flex items-center justify-between gap-2 px-2 py-2">
              <p className="truncate text-sm font-semibold text-zinc-950">{heroPreview.title}</p>
