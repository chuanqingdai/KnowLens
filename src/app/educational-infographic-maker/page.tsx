        ...
        <section className="grid gap-10 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-zinc-500">
              No design skills needed. Start with a lesson topic, study notes, or a short explanation.
            </p>
            <p className="mt-3 max-w-2xl text-sm leading-6 text-zinc-500">
              Built for classroom visuals, study guides, learning content, and visual explanation.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] border border-zinc-200 bg-white p-3 shadow-sm">
            <img
              src={heroImage}
              alt="Educational infographic collage with science and classroom learning labels"
              width={878}
              height={878}
              className="h-auto w-full rounded-[1.5rem] object-contain"
            />
            <p className="px-3 pb-3 pt-4 text-center text-sm text-zinc-500">
              Examples created from educational topics, notes, and plain text.
            </p>
          </div>
        </section>
